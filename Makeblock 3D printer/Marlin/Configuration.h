...
#define STRING_CONFIG_H_AUTHOR "(CC, default config)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {87.58,87.58,(200.0*16/0.7), 92.65}  // default steps per unit for ultimaker
